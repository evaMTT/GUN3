...
var archercolition = Matter.sat.collides(PlayerArrows[i].body,computerarcher.body);
var computercollition = Matter.sat.collides(PlayerArrows[i].body,computer.body);
if(baseCollision.collided || archercolition.collided || computercollition.collided){
